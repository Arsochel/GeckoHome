...
# По Reptifiles + AllAnglesCreatures (не RU-блоги):
#   0-2 мес (hatchling)      — каждый день, 5-7 шт
#   2-8 мес (juvenile/subadult) — раз в 2 дня, 5-8 шт
#   8+ мес (adult)           — раз в 3 дня, 4-8 шт
# NB: истинный ориентир — толщина хвоста (толще/равен шее = сыт, можно реже), возраст лишь дефолт.
_FEEDING_SCHEDULE = [
    (2, 1, 5, 7),
    (8, 2, 5, 8),
    (999, 3, 4, 8),
